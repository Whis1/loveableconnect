...
// Foto reale del corvo (PNG trasparente), una posa sola usata per tutto il
// percorso (arrivo, posa, partenza). Se manca o non carica, si usa il corvo
// SVG come fallback (così il prototipo non si rompe mai).
// Alternativa disponibile nella stessa cartella: crow-raven.png.
