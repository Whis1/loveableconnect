          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <Button
                ...
                variant="outline"
                className="h-auto py-3 px-4 bg-blue-500/10 hover:bg-blue-500/20 border-blue-500/30 text-blue-700 dark:text-blue-300 hover:border-blue-500/50 transition-all duration-200 flex items-center justify-center gap-2 animate-breath-slow"
              >
              ...
              <Button
                ...
                variant="outline"
                className="h-auto py-3 px-4 bg-red-500/10 hover:bg-red-500/20 border-red-500/30 text-red-700 dark:text-red-300 hover:border-red-500/50 transition-all duration-200 flex items-center justify-center gap-2 animate-breath-slow"
              >
                <span className="text-2xl">😈</span>
