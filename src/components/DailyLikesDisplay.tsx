    ...
    <div className="flex flex-col items-start gap-1">
      ...
      >
        ...
        <span className={`font-medium ${isMonthlyStandard ? 'text-blue-600 dark:text-blue-400' : isWeeklyPremium ? 'text-purple-600 dark:text-purple-400' : ''}`}>
          {Math.max(0, likesRemaining)} Like
        </span>
      </Button>
      {timeRemaining && likesRemaining < maxLikes && (
        // Sottotitolo compatto: solo orologio + tempo, niente piu' la dicitura
        // "Rinnovo giornaliero" che faceva la riga sotto piu' larga della
        // pillola sopra. L'icona orologio comunica gia' il senso del countdown.
        <div
