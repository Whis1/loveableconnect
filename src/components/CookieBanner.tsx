...
export const CookieBanner = ({ onConsent }: CookieBannerProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 animate-slide-in-bottom">
      <Card className="max-w-3xl mx-auto bg-gradient-to-br from-white via-pink-50/50 to-purple-50/50 dark:from-gray-900 dark:via-pink-950/30 dark:to-purple-950/30 border-2 border-pink-200 dark:border-pink-800 shadow-2xl">
        <div className="p-6">
