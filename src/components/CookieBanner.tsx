    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-in-bottom">
        <div className="max-w-4xl mx-auto m-4">
          <div className="bg-gradient-to-r from-pink-500/95 via-purple-500/95 to-pink-500/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
